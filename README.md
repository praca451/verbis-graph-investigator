...
The agent:
1. receives a diligence task
2. queries Verbis Graph for entities, relationships, supporting evidence, and contradictions
3. classifies risks and missing evidence
4. drafts a diligence memo with citations
